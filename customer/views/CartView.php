        ...
        <div class="card">
            <div class="card-header" style="color:#1b1b1b;">
                <?php if ($this->cartNumber() > 0) : ?>
                    <p class="text"><i>
                            <p style="color:#d40000;">Lưu ý: Các thông tin giao hàng sẽ là các thông tin đăng ký tài khoản, Quý khách có nhu cầu thay đổi vui lòng cập nhật trong phần thông tin cá nhân nếu có nhu cầu!</p> Đội ngũ NVN Shop xin Cảm ơn quý khách vì đã lựa chọn.
                        </i></p>
