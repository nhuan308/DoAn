    ...
    <div class="wrapper">
        ...
        <div class="header">
            ...
            <div class="container">
                <div class="header-inner">
                    <!--logo-->
                    <div class="logo">
                        <a href="index.php"><img src="Images/logo.png" style="width: 200px; padding-right:12px;"></a>
                    </div>
                    <!--end logo-->
                    <!--Menu bar-->
                    <nav class="nav">
        ...
        <div class="main-content">
            ...
            <div class="slider">
                ...
                <img src="Images/bannerttt.png" alt="">
        ...
        <footer class="footer">
            <div class="footer-top">
                <div class="container footer-content">
                    <div class="info">
                        <h2 class="logo-footer"><img src="Images/logo.png" style="width: 12%;"></h2>
                        <!--Footer search-->
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <ul class="list-contact">
                                <li class="item"><a href="#">Cửa hàng NVN Shop</a></li>
                                <li class="item"><a href="#">118, Cầu Diễn, Bắc Từ Liêm, Hà Nội</a></li>
                                <li class="item"><a href="#">Email: nvnshop@gmail.com</a></li>
            ...
            <div class="footer-bottom">
                <div class="container footer-bottom-content">
                    <div class="copyright">>©NVNShop - All Rights Reserved</div>
                    <div class="media">
