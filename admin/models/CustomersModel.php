<?php 
	trait CustomersModel{
		...
		public function modelUpdate(){
			...
			$db = Connection::getInstance();
			//chuan bi truy van
			$query = $db->prepare("update customers set name =:var_name ,email=:var_email,address=:var_address,phone=:var_phone, password=:var_password where id=:var_id");
			//thuc thi truy van, co truyen tham so vao cau lenh sql
			$query->execute(["var_id"=>$id,"var_name"=>$name,"var_email"=>$email,"var_address"=>$address,"var_phone"=>$phone, "var_password"=>$password]);
