<?php 
	trait UsersModel{
		...
		public function modelUpdate(){
			...
			$db = Connection::getInstance();
			//chuan bi truy van
			$query = $db->prepare("update users set name =:var_name, email=:var_email, password=:var_password where id=:var_id");
			//thuc thi truy van, co truyen tham so vao cau lenh sql
			$query->execute(["var_id"=>$id,"var_name"=>$name, "var_email"=>$email,"var_password"=>$password]);
